...
export class DefinitionBuilder{
    ...
    private getDefinition(hl7FieldName:string){
        switch(this._version){
            case Version.v2_1:
                return FieldDefinitionV2_1.getFieldDefinition(hl7FieldName);
            case Version.v2_2:
                return FieldDefinitionV2_2.getFieldDefinition(hl7FieldName);
            case Version.v2_3:
                return FieldDefinitionV2_3.getFieldDefinition(hl7FieldName);
            case Version.v2_3_1:
                return FieldDefinitionV2_3_1.getFieldDefinition(hl7FieldName);
            case Version.v2_4:
                return FieldDefinitionV2_4.getFieldDefinition(hl7FieldName);
            case Version.v2_5:
                return FieldDefinitionV2_5.getFieldDefinition(hl7FieldName);
            case Version.v2_5_1:
                return FieldDefinitionV2_5_1.getFieldDefinition(hl7FieldName);
            case Version.v2_6:
                return FieldDefinitionV2_6.getFieldDefinition(hl7FieldName);
            case Version.v2_7:
                return FieldDefinitionV2_7.getFieldDefinition(hl7FieldName);
            default:

...
export class Hl7Parser {
  ...
  //HL7 v2.3 
  // FieldParamsDict:any = {
  //   "MSH-3": new FieldParams("Sending Application", 180),
  //   "MSH-4":new FieldParams("Facility / Sub-Facility", 180),
  //   "MSH-4.0": new FieldParams("Facility", 180),
  //   "MSH-4.1": new FieldParams("Sub-Facility", 180),
  //   "MSH-5": new FieldParams("Receiving Application", 180),
  //   "MSH-6": new FieldParams("Receiving Facility", 180),
  //   "MSH-7": new FieldParams("Date/Time of Message", 26),
  //   "MSH-8": new FieldParams("Security", 40),
  //   "MSH-9": new FieldParams("Message Type", 7),
  //   "MSH-9.0": new FieldParams("Message Type", 7),
  //   "MSH-9.1": new FieldParams("Trigger Event", 7),
  //   "MSH-10": new FieldParams("Message Control Id", 20),
  //   "MSH-11": new FieldParams("Processing Id", 3),
  //   "MSH-12": new FieldParams("Version Id", 8),
  //   "MSH-13": new FieldParams("Sequence Number", 15),
  //   "MSH-14": new FieldParams("Continuation Pointer", 180),
  //   "MSH-15": new FieldParams("Accept Acknowledgement Type", 2),
  //   "MSH-16": new FieldParams("Application Acknowledgement Type", 2),
  //   "MSH-17": new FieldParams("Country Code", 2),
  //   "MSH-18": new FieldParams("Character Set", 6),
  //   "MSH-19": new FieldParams("Principal Language of Message", 3),


  //   "EVN-1": new FieldParams("Event Type Code", 3),
  //   "EVN-2": new FieldParams("Recorded Date/Time", 26),
  //   "EVN-3": new FieldParams("Date/Time Planned Event", 26),
  //   "EVN-4": new FieldParams("Event Reason Code", 3),
  //   "EVN-5": new FieldParams("Operator ID", 60),
  //   "EVN-6": new FieldParams("Event Occurred", 26),


  //   "PID-1": new FieldParams("Set ID - Patient ID", 4),
  //   "PID-2": new FieldParams("Patient ID (External ID)", 16),
  //   "PID-3": new FieldParams("Patient ID (Internal ID)", 20),
  //   "PID-4": new FieldParams("Alternate Patient ID", 12),
  //   "PID-5": new FieldParams("Patient Name", 48),
  //   "PID-6": new FieldParams("Mother's Maiden Name", 48),
  //   "PID-7": new FieldParams("Date of Birth", 26),
  //   "PID-8": new FieldParams("Sex", 1),
  //   "PID-9": new FieldParams("Patient Alias", 48),
  //   "PID-10":new FieldParams("Race", 1),
  //   "PID-11":new FieldParams("Patient Address", 106),
  //   "PID-12":new FieldParams("County Code", 4),
  //   "PID-13":new FieldParams("Phone Number - Home", 40),
  //   "PID-14":new FieldParams("Phone Number - Business", 40),
  //   "PID-15":new FieldParams("Primary Language", 60),
  //   "PID-16":new FieldParams("Marital Status", 1),
  //   "PID-17":new FieldParams("Religion", 3),
  //   "PID-18":new FieldParams("Patient Account Number", 20),
  //   "PID-19":new FieldParams("SSN Number - Patient", 16),
  //   "PID-20":new FieldParams("Driver's License Number", 25),
  //   "PID-21":new FieldParams("Mother's Identifier", 20),
  //   "PID-22":new FieldParams("Ethnic Group", 3),
  //   "PID-23":new FieldParams("Birth Place", 60),
  //   "PID-24":new FieldParams("Multiple Birth Indicator", 2),
  //   "PID-25":new FieldParams("Birth Order", 2),
  //   "PID-26":new FieldParams("Citizenship", 4),
  //   "PID-27":new FieldParams("Veterans Military Status", 60),
  //   "PID-28":new FieldParams("Nationality Code", 80),
  //   "PID-29":new FieldParams("Patient Death Date and Time", 26),
  //   "PID-30":new FieldParams("Patient Death Indicator", 1),
